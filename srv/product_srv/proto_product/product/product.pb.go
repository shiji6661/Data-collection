...
const file_product_proto_rawDesc = "" +
	...
	"\x04List\x18\x01 \x03(\v2\x17.product.NewProductListR\x04List\"X\n" +
	"\x0eAddCartRequest\x12\x16\n" +
	"\x06UserId\x18\x01 \x01(\x03R\x06UserId\x12\x1c\n" +
	"\tProductId\x18\x02 \x01(\x03R\tProductId\x12\x10\n" +
	"\x03Num\x18\x03 \x01(\x03R\x03Num\"+\n" +
	"\x0fAddCartResponse\x12\x18\n" +
	"\aSuccess\x18\x01 \x01(\tR\aSuccess\"e\n" +
	"\x15RemoveFromCartRequest\x12\x16\n" +
	"\x06UserId\x18\x01 \x01(\x03R\x06UserId\x12\x1c\n" +
	"\tProductId\x18\x02 \x01(\x03R\tProductId\x12\x16\n" +
	"\x06CartId\x18\x03 \x01(\tR\x06CartId\"2\n" +
	...
	"\aSuccess\x18\x01 \x01(\tR\aSuccess\"0\n" +
	"\x16CartProductListRequest\x12\x16\n" +
	"\x06UserId\x18\x01 \x01(\x03R\x06UserId\"D\n" +
	"\x17CartProductListResponse\x12)\n" +
	"\x04List\x18\x01 \x03(\v2\x15.product.ProductItemsR\x04List\"\xa4\x01\n" +
	"\fProductItems\x12\x16\n" +
	"\x06UserId\x18\x01 \x01(\x03R\x06UserId\x12\x1c\n" +
	"\tProductId\x18\x02 \x01(\x03R\tProductId\x12\x10\n" +
	"\x03Num\x18\x03 \x01(\x03R\x03Num\x12\x14\n" +
	"\x05Price\x18\x04 \x01(\x02R\x05Price\x12 \n" +
	"\vProductName\x18\x05 \x01(\tR\vProductName\x12\x14\n" +
	"\x05Check\x18\x06 \x01(\x03R\x05Check\"1\n" +
	"\x17CartProductCountRequest\x12\x16\n" +
	"\x06UserId\x18\x01 \x01(\x03R\x06UserId\"0\n" +
	"\x18CartProductCountResponse\x12\x14\n" +
	"\x05Total\x18\x01 \x01(\x03R\x05Total\"6\n" +
	"\x1cCartProductTotalPriceRequest\x12\x16\n" +
	"\x06UserId\x18\x01 \x01(\x03R\x06UserId\"?\n" +
	"\x1dCartProductTotalPriceResponse\x12\x1e\n" +
	"\n" +
	"TotalPrice\x18\x01 \x01(\x02R\n" +
	"TotalPrice2\xb1\x14\n" +
	"\aProduct\x12H\n" +
	...
	"\x0fProductSearchES\x12\x1f.product.ProductSearchESRequest\x1a .product.ProductSearchESResponse\x12<\n" +
	"\aAddCart\x12\x17.product.AddCartRequest\x1a\x18.product.AddCartResponse\x12Q\n" +
	"\x0eRemoveFromCart\x12\x1e.product.RemoveFromCartRequest\x1a\x1f.product.RemoveFromCartResponse\x12E\n" +
	"\n" +
	"UpdateCart\x12\x1a.product.UpdateCartRequest\x1a\x1b.product.UpdateCartResponse\x12B\n" +
	"\tClearCart\x12\x19.product.ClearCartRequest\x1a\x1a.product.ClearCartResponse\x12T\n" +
	"\x0fCartProductList\x12\x1f.product.CartProductListRequest\x1a .product.CartProductListResponse\x12W\n" +
	"\x10CartProductCount\x12 .product.CartProductCountRequest\x1a!.product.CartProductCountResponse\x12f\n" +
	"\x15CartProductTotalPrice\x12%.product.CartProductTotalPriceRequest\x1a&.product.CartProductTotalPriceResponseB\vZ\t.;productb\x06proto3"
...
var file_product_proto_msgTypes = make([]protoimpl.MessageInfo, 66)
var file_product_proto_goTypes = []any{
	...
	(*AddCartRequest)(nil),                // 51: product.AddCartRequest
	(*AddCartResponse)(nil),               // 52: product.AddCartResponse
	(*RemoveFromCartRequest)(nil),         // 53: product.RemoveFromCartRequest
	(*RemoveFromCartResponse)(nil),        // 54: product.RemoveFromCartResponse
	(*UpdateCartRequest)(nil),             // 55: product.UpdateCartRequest
	(*UpdateCartResponse)(nil),            // 56: product.UpdateCartResponse
	(*ClearCartRequest)(nil),              // 57: product.ClearCartRequest
	(*ClearCartResponse)(nil),             // 58: product.ClearCartResponse
	(*CartProductListRequest)(nil),        // 59: product.CartProductListRequest
	(*CartProductListResponse)(nil),       // 60: product.CartProductListResponse
	(*ProductItems)(nil),                  // 61: product.ProductItems
	(*CartProductCountRequest)(nil),       // 62: product.CartProductCountRequest
	(*CartProductCountResponse)(nil),      // 63: product.CartProductCountResponse
	(*CartProductTotalPriceRequest)(nil),  // 64: product.CartProductTotalPriceRequest
	(*CartProductTotalPriceResponse)(nil), // 65: product.CartProductTotalPriceResponse
}
var file_product_proto_depIdxs = []int32{
	...
	61, // 7: product.CartProductListResponse.List:type_name -> product.ProductItems
	4,  // 8: product.Product.ProductInfo:input_type -> product.ProductInfoRequest
	9,  // 9: product.Product.ProductFilter:input_type -> product.ProductFilterRequest
	7,  // 10: product.Product.ProductCategory:input_type -> product.ProductCategoryRequest
	0,  // 11: product.Product.ProductKeyword:input_type -> product.ProductKeywordRequest
	2,  // 12: product.Product.ProductRecommend:input_type -> product.ProductRecommendRequest
	12, // 13: product.Product.AddToCart:input_type -> product.AddToCartRequest
	16, // 14: product.Product.CreateBargainProduct:input_type -> product.CreateBargainProductRequest
	14, // 15: product.Product.AddProduct:input_type -> product.AddProductRequest
	18, // 16: product.Product.MerchantDeletePro:input_type -> product.MerchantDeleteProRequest
	20, // 17: product.Product.CreateBargainUser:input_type -> product.CreateBargainUserRequest
	24, // 18: product.Product.AddGroupProduct:input_type -> product.AddGroupProductRequest
	28, // 19: product.Product.RemoveGroupProduct:input_type -> product.RemoveGroupProductRequest
	30, // 20: product.Product.CreateUserGroup:input_type -> product.CreateUserGroupRequest
	26, // 21: product.Product.CreateBargainUserHelp:input_type -> product.CreateBargainUserHelpRequest
	22, // 22: product.Product.CartTotalPrice:input_type -> product.CartTotalPriceRequest
	32, // 23: product.Product.ProductList:input_type -> product.ProductListRequest
	35, // 24: product.Product.AddCoupon:input_type -> product.AddCouponRequest
	37, // 25: product.Product.MerAddCouponStore:input_type -> product.MerAddCouponStoreRequest
	39, // 26: product.Product.MerDeleteCouponStore:input_type -> product.MerDeleteCouponStoreRequest
	41, // 27: product.Product.AddSpikeProduct:input_type -> product.AddSpikeProductRequest
	43, // 28: product.Product.FlashSale:input_type -> product.FlashSaleRequest
	45, // 29: product.Product.UserJoinGroup:input_type -> product.UserJoinGroupRequest
	47, // 30: product.Product.ProductCreateToES:input_type -> product.ProductCreateToESRequest
	49, // 31: product.Product.ProductSearchES:input_type -> product.ProductSearchESRequest
	51, // 32: product.Product.AddCart:input_type -> product.AddCartRequest
	53, // 33: product.Product.RemoveFromCart:input_type -> product.RemoveFromCartRequest
	55, // 34: product.Product.UpdateCart:input_type -> product.UpdateCartRequest
	57, // 35: product.Product.ClearCart:input_type -> product.ClearCartRequest
	59, // 36: product.Product.CartProductList:input_type -> product.CartProductListRequest
	62, // 37: product.Product.CartProductCount:input_type -> product.CartProductCountRequest
	64, // 38: product.Product.CartProductTotalPrice:input_type -> product.CartProductTotalPriceRequest
	5,  // 39: product.Product.ProductInfo:output_type -> product.ProductInfoResponse
	10, // 40: product.Product.ProductFilter:output_type -> product.ProductFilterResponse
	8,  // 41: product.Product.ProductCategory:output_type -> product.ProductCategoryResponse
	1,  // 42: product.Product.ProductKeyword:output_type -> product.ProductKeywordResponse
	3,  // 43: product.Product.ProductRecommend:output_type -> product.ProductRecommendResponse
	13, // 44: product.Product.AddToCart:output_type -> product.AddToCartResponse
	17, // 45: product.Product.CreateBargainProduct:output_type -> product.CreateBargainProductResponse
	15, // 46: product.Product.AddProduct:output_type -> product.AddProductResponse
	19, // 47: product.Product.MerchantDeletePro:output_type -> product.MerchantDeleteProResponse
	21, // 48: product.Product.CreateBargainUser:output_type -> product.CreateBargainUserResponse
	25, // 49: product.Product.AddGroupProduct:output_type -> product.AddGroupProductResponse
	29, // 50: product.Product.RemoveGroupProduct:output_type -> product.RemoveGroupProductResponse
	31, // 51: product.Product.CreateUserGroup:output_type -> product.CreateUserGroupResponse
	27, // 52: product.Product.CreateBargainUserHelp:output_type -> product.CreateBargainUserHelpResponse
	23, // 53: product.Product.CartTotalPrice:output_type -> product.CartTotalPriceResponse
	33, // 54: product.Product.ProductList:output_type -> product.ProductListResponse
	36, // 55: product.Product.AddCoupon:output_type -> product.AddCouponResponse
	38, // 56: product.Product.MerAddCouponStore:output_type -> product.MerAddCouponStoreResponse
	40, // 57: product.Product.MerDeleteCouponStore:output_type -> product.MerDeleteCouponStoreResponse
	42, // 58: product.Product.AddSpikeProduct:output_type -> product.AddSpikeProductResponse
	44, // 59: product.Product.FlashSale:output_type -> product.FlashSaleResponse
	46, // 60: product.Product.UserJoinGroup:output_type -> product.UserJoinGroupResponse
	48, // 61: product.Product.ProductCreateToES:output_type -> product.ProductCreateToESResponse
	50, // 62: product.Product.ProductSearchES:output_type -> product.ProductSearchESResponse
	52, // 63: product.Product.AddCart:output_type -> product.AddCartResponse
	54, // 64: product.Product.RemoveFromCart:output_type -> product.RemoveFromCartResponse
	56, // 65: product.Product.UpdateCart:output_type -> product.UpdateCartResponse
	58, // 66: product.Product.ClearCart:output_type -> product.ClearCartResponse
	60, // 67: product.Product.CartProductList:output_type -> product.CartProductListResponse
	63, // 68: product.Product.CartProductCount:output_type -> product.CartProductCountResponse
	65, // 69: product.Product.CartProductTotalPrice:output_type -> product.CartProductTotalPriceResponse
